    ...
    <section className="about">
      <div className="container">
        ...
        <p>
          ...
          incorporated into this Agreement by reference. All defined terms in
          this Agreement have the meaning given to them in the Taklief Glossary.
        </p>

        <p>&nbsp;</p>

        <h6>1. SCOPE OF TAKLIEF SERVICES</h6>
        ...
        <h6>2. TAKLIEF’S ROLE AND OBLIGATIONS</h6>
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                Contract; or
                <br />
                (b) following reasonable but unsuccessful attempts by a Poster
                to contact a Tasker to perform the Task Contract, the Task
                Contract is cancelled by the Poster; or
                <br />
                (c) the Tasker cancels the Task Contract; or
                <br />
                (d) a Task Contract is cancelled in accordance with clause 3.14
                as a result of the Tasker’s actions or breach.
              </li>
              <br />
              <br />
              <br />
            ...
            <ul>
              <li>
                (a) the Poster cancels the Task Contract (other than in
                accordance with clause 5.5(b); or
                <br />
                (b) a Task Contract is cancelled in accordance with clause 3.14
                as a result of the Poster’s actions or breach..
              </li>
              <br />
              <br />
              <br />
        ...
        <ul>
          <li>
            ...
            <br />
            (b) the terms of the Business Partner Contract will prevail to the
        ...
        <h6>10. VERIFICATION &amp; BADGES</h6>

        <ul>
          <li>
            10.1 Taklief may use Identity Verification Services.
            <br />
        ...
        <ul>
          <li>
            ...
            future moneys it may owe to You.
            <br />
            11.6 You acknowledge and agree that in the event that a claim is
            made relating to any services performed and/or goods provided by a
            Tasker, and the insurance taken out by Taklief (if any) does not
            respond to the claim or the claim is below the excess payable to the
            insurer, then this clause applies. Taklief may elect to reject or
            pay an amount to settle a claim not covered by Taklief's own
            insurance policies. To the extent that the Tasker was or would be
            liable for the amount of the claim, if Taklief elects to pay an
            amount to settle the claim the amount paid by Taklief may be
            recovered by Taklief from the Tasker. Taklief may also elect to set
            this amount off against future moneys it may owe to the Tasker.
          </li>
          <br />
          <br />
          <br />
        ...
        <ul>
          <li>
            ...
            Taklief via the Taklief Platform.
            <br />
            12.2 Taklief is entitled to suspend or terminate Your account at any
            time if Taklief, in its sole and absolute discretion, is concerned
            by any feedback about You, or considers Your feedback rating to be
            problematic for other Taklief Users.
          </li>
          <br />
          <br />
          <br />
        ...
        <h6>15. MODIFICATIONS TO THE AGREEMENT</h6>
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                User is notified that the email address is invalid or the email
        ...
        <h6>18. MEDIATION AND DISPUTE RESOLUTION</h6>
        ...
        <ul>
          <li>
            ...
            service of the Third Party Service provider. 18.7 If You have a
            complaint about the Taklief Service please contact us here. 18.8 If
            Taklief provides information about other Users to You for the
            ...
            responsible and liable to Taklief for any costs, losses or
            liabilities incurred by Taklief in relation to any claims relating
        ...
        <ul>
          <li>
            ...
            <br />
            Revised July 2020 copyright Taklief 2020
          </li>
          <br />
          <br />
          <br />
        ...
        <ul>
          <li>
            1.1 The Task Contract is created when the Poster accepts the
            Tasker's Offer on a Posted Task to provide Services. When using
            Search Assist, the Task Contract is created when the Tasker makes an
            Instant Claim.
            <br />
            1.2 The Contract will continue until terminated in accordance with
            clause 7.
          </li>
        </ul>
        ...
        <ul>
          <li>
            2.1 The Tasker will perform Services in a proper and workmanlike
            manner.
            <br />
            2.2 The Tasker must perform the Services at the time and location
            agreed.
            <br />
            2.3 The parties must perform their obligations in accordance with
            any other terms or conditions agreed by the parties during or
            subsequent to the creation of the Task Contract.
            <br />
            2.4 The parties acknowledge that the Task Contract is one of
            personal service where the Poster selected the Tasker to perform the
            ...
            <br />
            2.5 The Tasker remains responsible and liable at all times to the
            Poster for any acts or omissions of a subcontractor as if those acts
            or omissions had been made by the Tasker.
          </li>
          <br />
          <br />
          <br />
        ...
        <ul>
          <li>
            ...
            creation of the Task Contract is true and accurate.
            <br />
            3.2 The Tasker warrants that they have (and any subcontractor has)
            the right to work and provide Services and hold all relevant
            licences in the jurisdiction where the Services are performed.
          </li>
          <br />
          <br />
          <br />
        ...
        <ul>
          <li>
            ...
            with clause 2, the Poster must use the Taklief Platform to release
            ...
            Taklief from the Payment Account to the Tasker unless paused by the
            Poster in accordance with the User's Taklief Agreement.
            <br />
            4.4 If the parties agree to cancel the Task Contract, or the Poster
            is unable to contact the Tasker to perform the Task Contract, the
            Tasker Funds will be dealt with in accordance with the User's
            Taklief Agreement.
          </li>
          <br />
          <br />
        ...
        <ul>
          <li>
            ...
            <br />
            6.2 If the parties are unable to resolve the dispute in accordance
            with clause 6.1, either party may refer the dispute to Taklief and
            act in accordance with clause 18 of the Taklief Agreement.
          </li>
          <br />
          <br />
          <br />
        ...
        <h6>7 TERMINATION OF CONTRACT</h6>

        <p>The Task Contract will terminate when:</p>

        <ul>
          <li>
            (a) the Services are completed and the Agreed Price is released from
            the Payment Account;
            <br />
            (b) a party is terminated or suspended from the Taklief Platform, at
            the election of the other party;
            <br />
            (c) otherwise agreed by the parties or the Third Party Dispute
            Service; or
            <br />
            (d) notified by Taklief in accordance with the party's Taklief
            Agreement.
          </li>
          <br />
          <br />
        ...
        <h6>8 APPLICATION OF POLICIES</h6>
        ...
        <p>
          ...
          the Posted Task was posted on the Taklief Platform. Revised July 2020
          copyright Taklief 2020
        </p>
        ...
        <h4>COUNTRY SPECIFIC TERMS</h4>

        <h6>1. The kingdom of Saudi Arabian Terms</h6>
        ...
        <ul>
          <li>
            ...
            <ul>
              <li>
                a) a reference to SAR﷼ ,﷼ SAR, SAR or ﷼ is to The kingdom of
                Saudi Arabian currency;
                <br />
                b) "" means Taklief;
                <br />
                c) "SCL" means the Saudi Arabian Consumer Law;
                <br />
                d) "Consumer Guarantees" means the consumer guarantees contained
                in Part 3-2 of the SCL;
                <br />
                e) "Personal Information" has the same meaning given to it in
                the Privacy (NA);
                <br />
                f) This Agreement is governed by the laws of The kingdom of
                Saudi Arabia. You and Taklief submit to the exclusive
                jurisdiction of the courts of The kingdom of Saudi Arabia; and
                <br />
                g) The following is added as clause 3.3 in the Model Contract of
                Appendix A "3.3 The parties incorporate the Consumer Guarantees
                into the Task Contract, even if they are not already
                incorporated by law.";
                <br />
                h) The exclusions and limitations of liability shall be as
                follows:
              </li>
              <br />
              <br />
            ...
            direct, indirect and consequential) of every kind and nature, known
            and unknown, suspected and unsuspected, disclosed and undisclosed
            (including, without limitation, loss or damage relating to any
            inaccuracy of information provided, or the lack of fitness for
            purpose of any goods or service supplied), arising out of or in any
            way connected with any transaction between Posters and Taskers.
            <br />
            (2) Except for liability in relation to a breach of any
            Non-excludable Condition, to the extent permitted by law, Taklief
            specifically disclaims all liability for any loss or damage (actual,
            special, direct, indirect and consequential) of every kind and
            nature, known and unknown, suspected and unsuspected, disclosed and
            undisclosed (including, without limitation, loss or damage relating
            to any inaccuracy of information provided, or the lack of fitness
            for purpose of any goods or service supplied), arising out of or in
            any way connected with any transaction between You and any Third
            Party Service provider who may be included from time to time on the
            Taklief Platform.
            <br />
            (3) Except for liability in relation to a breach of any
            Non-excludable Condition, and to the extent permitted by law,
            Taklief is not liable for any Consequential Loss arising out of or
            in any way connected with the Taklief Services.
            <br />
            (4) Except for liability in relation to a breach of any
            Non-excludable Condition, Taklief's liability to any User of the
            Taklief Service is limited to the total amount of payment made by
            that User to Taklief during the twelve month period prior to any
            incident causing liability of Taklief, or SAR50.00, whichever is
            greater.
            <br />
            (5) Taklief's liability to You for a breach of any Non-excludable
            Condition (other than a Non-excludable Condition that by law cannot
            be limited) is limited, at our option to any one of resupplying,
            replacing or repairing, or paying the cost of resupplying, replacing
            or repairing goods in respect of which the breach occurred, or
            supplying again or paying the cost of supplying again, services in
        ...
        <h6>2. The kingdom of Saudi Arabia Terms</h6>
        ...
        <ul>
          <li>
            a) "Taklief" means Taklief SA Limited a company registered in Saudi
            Arabia under company number (NA), with its registered office at
            (NA), email support@Taklief.com and VAT number (NA);
            <br />
            b) A reference to "SAR" is to Saudi Riyal, the currency of The
            kingdom of Saudi Arabia;
            <br />
            c) The Non-Excludable Conditions include
            <ul>
              <li>
                (i) the implied terms under the Sale of Goods and Supply of
                Services Act 1893 -1980 (as amended), which include (without
                limitation) that Taklief's Services under this Agreement will be
                performed with due skill, care and diligence and that materials
                used will be sound and fit for purpose.
              </li>
            </ul>
            <br />
            ...
            <ul>
              <li>
                (1) Nothing in this Agreement excludes or limits Taklief's
                liability for:
                <br />
                (i) death or personal injury caused by Taklief’s negligence;
                <br />
                (ii) fraud or fraudulent misrepresentation; and
                <br />
                (iii) any matter in respect of which it would be unlawful for
                Taklief to exclude or restrict its liability.
              </li>
              <br />
              <br />
              <br />
            ...
            (2) If Taklief fails to comply with the terms of this Agreement,
            Taklief is responsible for loss or damage You suffer that is a
            foreseeable result of Taklief's breach of this Agreement or
            Taklief's negligence, but Taklief is not responsible for any loss or
            damage that is not foreseeable. Loss or damage is foreseeable if it
            was an obvious consequence of Taklief's breach or if it was
            contemplated by You and Taklief at the time that this Agreement
            became binding.
            <br />
            (3) Save as set out in paragraph (1) above, Taklief shall not be
            liable to You for any loss or damage arising out of or in any way
            connected with:
            <ul>
              <li>
                (i) any transaction between Posters and Taskers; and
                <br />
                (ii) any Third Party Service provider who may be included from
                time to time on the Taklief Platform.
              </li>
            </ul>
            (4) Save as set out in paragraph (1) above, Taklief's liability to
            any User under this Agreement is limited to the total amount of
            payment made by that User to Taklief during the twelve month period
            prior to any incident causing liability of Taklief, or €30.00,
            whichever is greater;
            <br />
            e) The governing law and jurisdiction shall be as follows:
            <ul>
              <li>
                (1) This Agreement shall be governed by Irish law. This means
                that Your access to and use of the Taklief Platform, and any
                dispute or claim arising out of or in connection with it
                (including non-contractual disputes or claims) will be governed
                by Irish law.
                <br />
                (2) You can bring proceedings in respect of this Agreement in
                the Irish courts. However, as a consumer, if You live in another
                European Union Member State You can bring legal proceedings in
                respect of this Agreement in either the Irish courts or the
                courts of that Member State.
                <br />
                (3) As a consumer, if You are resident in the European Union and
                Taklief directs the Taklief Platform to the Member State in
                which You are resident, You will benefit from any mandatory
                provisions of the law of the country in which You are resident.
                Nothing in this Agreement, including paragraph (1) above,
                affects Your rights as a consumer to rely on such mandatory
                provisions of local law.
                <br />
                (4) If we are not able to satisfy Your complaint about our
                Services, then Your complaint can be addressed to the Online
                Dispute Resolution website at http://ec.europa.eu/consumers/odr/
                an official website managed by the European Commission dedicated
                to helping consumers and traders resolve their disputes
                out-of-court.
              </li>
              <br />
              <br />
            ...
            f) The following VAT provisions shall apply:
            <ul>
              <li>
                (1) If You are a Tasker, You must have the right to provide
                Services under a Task Contract and to work in the kingdom of
                Saudi Arabia and You must not be established for VAT purposes
                outside The kingdom of Saudi Arabia. You must comply with VAT
                and regulatory obligations in relation to any payment (including
                the Tasker Funds) received under a Task Contract. You must not
                sell goods as a separate supply through the Taklief Platform. If
                there is an incidental supply of goods as part of a supply of
                Services, then paragraph (2) will apply.
                <br />
                (2) If the supply of any goods is part of a single supply of
                services for VAT purposes (and is not a separate supply), then
                the consideration for such goods will be part of the Agreed
                Price. If You are a Tasker and You supply any goods in
                conjunction with Your Services and such goods would constitute a
                separate supply for VAT purposes, then:
              </li>
              <br />
              <br />
              <br />
            ...
            <ul>
              <li>
                (i) You must supply such goods outside of the Taklief Platform
                and under a separate contract between You and the Poster; and
                <br />
                (ii) the Agreed Price shall not constitute consideration for
                such goods and be dealt with in accordance with paragraph (1)
                above.
              </li>
              <br />
              <br />
            ...
            g) The Service Fee and/or the Cancellation Admin Fee only becomes
            payable to Taklief under this Agreement once Taklief has performed
            its services. Therefore, You are not entitled to cancellation rights
            under the European Union (Consumer Information, Cancellation and
            Other Rights) Regulations 2013 in relation to the Service Fee and/or
            the Cancellation Admin Fee.
          </li>
          <br />
          <br />
          <br />
        ...
        <p>
          ...
          <br />
          "Taklief Platform" means the Taklief website at&nbsp;
          <a href="#">http://www.Taklief.com/</a>
          &nbsp;Taklief smartphone app, and any other affiliated platform that
        ...
        <p>
          ...
          incurred by any person in a similar situation to the person suffering
          or incurring the loss, damage or expense; or (b) which is a loss of:
        </p>
        ...
        <ul>
          <li>
            ...
            c. data; or
            <br />
            d. value of any equipment,and any costs or expenses incurred in
        ...
        <ul>
          <li>
            ...
            <br />
            (c) a reference to a document or instrument includes the document or
            instrument as novated, altered, supplemented or replaced from time
            to time;
            <br />
            (d) the applicable currency shall be the currency specified in Your
            Country Specific Terms;
            <br />
            (e) a reference to a person includes a natural person, partnership,
            body corporate, association, governmental or local authority or
            agency or other entity;
            <br />
            (f) a reference to a statute, ordinance, code or other law includes
            regulations and other instruments under it and consolidations,
            amendments, re-enactments or replacements of any of them;
            <br />
            (g) the meaning of general words is not limited by specific examples
            ...
            party because the party was responsible for the preparation of this
