  ...
  return (
    <div className="relative flex text-left" ref={dropdownRef}>
      <button
        type="button"
        onClick={toggleMenu}
        className={`inline-flex items-center justify-center gap-x-1.5 rounded-[10px] bg-white font-sfpro text-base font-semibold ring-gray-300 ring-transparent ${
      ...
      {/* Dropdown menu */}
      {isOpen && (
        <div className="absolute right-2 top-11 z-10 min-w-[170px] origin-top-right rounded-[10px] border border-slate-300 bg-white">
