  ...
  return (
    <section id="community-guideline">
      <div className="container">
        ...
        <h6>C. No escort or adult services</h6>
        ...
        <h6>D. Clear scope, time and budget required</h6>
        ...
        <ul>
          <li>
            <strong>Example 1:</strong>&nbsp;Sarah posted a task asking Taskers
            to leave 5 star reviews on her company's website and Google maps.
            Sarah’s task was immediately cancelled from Taklief and she was
            advised her task did not follow the Community Guidelines. Academic
            activities and assignment based tasks are strictly prohibited. This
            includes but is not limited to completing an assignment, test or
            course on someones behalf. Additionally, academic assistance in the
            form of proofreading, editing, planning, structuring, referencing
            and giving feedback on someone else's academic work is also not
            supported.
            <br />
            <br />
            <br />
            ...
            the French Revolution. Ahmed was contacted shortly after posting his
            task and advised the post had been cancelled, as it was a
            proofreading task and therefore not supported on Taklief. We also
            don’t allow tasks that request quotes for work to be done outside of
            Taklief.
            <br />
            <br />
            <br />
            ...
            paint his 3 bedroom house. The task was cancelled by Taklief because
            it was asking for a quote and not for someone to actually paint the
            house. Tasks that require someone to be nude, topless or wear
            clothing like lingerie, swimwear and gym wear are not supported.
            <br />
            <br />
            <br />
            <strong>Example 4:</strong>&nbsp;Joanne posted a task looking for a
            Tasker to model for a bikini photoshoot. The task was cancelled as
            the Tasker would be required to wear a bikini. Tasks that involve
            investigating or gathering information on an individual or business
            without their knowledge and consent are not supported. Debt
            collection tasks are also not supported. Tasks that ask for someone
            to withdraw cash, buy gift cards, vouchers for the Poster or to send
            money to the Poster via methods like direct bank transfers or STCPay
            are not supported.
          </li>
          <br />
          <br />
